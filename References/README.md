...
IEEE. (2019). *Ethically aligned design: A vision for prioritizing human well-being with autonomous and intelligent systems* (1st ed.). https://standards.ieee.org/wp-content/uploads/import/documents/other/ead_v2.pdf

Matplotlib Development Team. (2025). *Matplotlib documentation*. https://matplotlib.org/stable/
